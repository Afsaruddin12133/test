          ...
          <div className="mt-2 flex items-center justify-between text-[13px]">
            <div className="flex flex-col gap-1">
              ...
              <span className="font-bold text-green-600">
                BDT {Number(course.student_offer || 0).toLocaleString("en-US", {
            ...
            <div className="flex flex-col gap-1 text-right">
              ...
              <span className="font-bold text-blue-600">
                BDT {Number(course.tutor_offer || 0).toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })}
              </span>
...
const Negotiation = () => {
  ...
  const fetchNegotiations = async (page = 1) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(`HTTP ${response.status}: Failed to fetch negotiations`);
      }
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-white rounded-2xl shadow-xl">
              ...
              <p className="text-gray-600 mb-6">
                You don't have any ongoing price negotiations. Browse courses and start negotiating!
              </p>
              <Link
                to={getBrowseLink()}
